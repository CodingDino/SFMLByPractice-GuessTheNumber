...
// curly bracket that starts the main() function.
{
	...
	// Create a variable to hold the player's response to restarting the game
	// Assign a value of 'y' to the variable by default
	char restartResponse = 'y';

	// Start a loop for the entire game to repeat
	// The loop stops repeating if the player does not respond with 'y'
	while (restartResponse == 'y')
	{
		// This code will be repeated until the response is not 'y'
		...
		// Print a note that the number has been chosen
		std::cout << "A secret number has been chosen!" << std::endl;
		std::cout << std::endl;
		...
		// The loop stops repeating when the correct number has been guessed
		while (guess != secretNumber)
		{
			...
			if (guess == secretNumber)
			{
				...
				// Print out a prompt to see if the player wants to restart
				std::cout << "If you would like to play again, type y" << std::endl;
				std::cout << "> ";

				// Get input from the player and store it in the restartResponse variable
	...
	} // end of game repeat loop

	// -----------------------------------------------
	// End the program
	// -----------------------------------------------

	// Print a thank you message to the player
	std::cout << std::endl;
